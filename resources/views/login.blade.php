...
<head>
    ...
    <title>Sign In - ToffeeBean</title>
    <meta name="description" content="Sign in to Toffee's Private Workshop Room to reserve vinyl sticker packs, manage commissions, and access your patron dashboard.">
...
<body>
    ...
    <script>
        ...
        window.__STATUS__ = @json(session('status'));
    </script>
            ...
            return (
                <div className="w-full max-w-[540px] bg-white border-[3px] border-[#4a2c11] rounded-[2rem] p-8 relative shadow-[6px_6px_0_0_#4a2c11]">
                    ...
                    <div className="flex rounded-full border-[3px] border-[#4a2c11] p-1 mb-6 bg-[#fff8f0]">
                        ...
                        <a href="/register" className="flex-1 py-2 text-center font-bold text-[13px] text-[#4a2c11]/70 hover:text-[#4a2c11] transition-colors flex items-center justify-center">
                            Create Account
                        </a>
                    </div>
