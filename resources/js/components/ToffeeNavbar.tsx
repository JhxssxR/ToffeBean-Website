...
export function ToffeeNavbar() {
    ...
    return (
        <nav className="flex items-center justify-between px-6 py-5 max-w-7xl mx-auto bg-[#fff8f0]">
                    ...
                    return (
                        <Link
                            ...
                            className={`px-5 py-2.5 rounded-full transition-all flex items-center gap-2 font-bold ${isActive
                                    ...
                                    : link.label === 'Sign In'
                                        ? 'bg-white/40 border-[3px] border-transparent hover:bg-[#fff8f0] hover:border-[#4a2c11] hover:shadow-brutal hover:text-[#4a2c11] text-[#4a2c11]'
