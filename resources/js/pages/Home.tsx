        ...
        <section className="flex flex-col md:flex-row items-center gap-12 pt-12 pb-8">
            <div className="flex-1 space-y-6">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.15] tracking-tight">
                    <span className="text-[#4a2c11] block whitespace-nowrap">{settings.hero_title_1 ?? 'Cute illustrations,'}</span>
                    <span className="text-[#E67E22] block whitespace-nowrap">{settings.hero_title_2 ?? 'creativity filled!'}</span>
                </h1>
